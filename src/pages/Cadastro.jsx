...
function Cadastro() {
  return (
    <Container>
      ...
      <Form className="form">
        ...
        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
          ...
          <Form.Control 
            ...
            placeholder="Senha"
          />
                    <Form.Control className="textos" type="Confirmar Senha" placeholder="Confirmar Senha" />
      ...
      />
      <a href="/Login" className="voltarlogin">Voltar ao login</a>
      </div>
        <a href="" className="logar">Cadastro</a>
      </Form>
    </Container>
  );
}
